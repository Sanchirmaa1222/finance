                                ...
                                <form class="form-horizontal my-4" action="/sign-up-save" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" value="99554477" id="phone"
                                                name="phone" placeholder="Өөрийн утасны дугаараа оруул">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-4">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="terms">
                                                <span class="font-13 text-muted mb-0">Бүртгүүлснээр би <?=DOMAIN?>
                                                    сайтын
                ...
                <div class="col-lg-9 p-0 vh-100  d-flex justify-content-center">
                    <div class="accountbg d-flex align-items-center">
                        <div class="account-title text-center text-white">
                            ...
                            <p class="mt-3 font-size-14">Гэр бүлийнхээ санхүүгийн байдлыг хамгийн хялбараар авч явж,
                                харж
